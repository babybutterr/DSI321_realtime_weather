# Real-Time PM2.5 Monitoring Dashboard
...
&nbsp;&nbsp;&nbsp;&nbsp;จากการวิเคราะห์ข้อมูลและสร้างโมเดล เราสามารถสรุปปัจจัยที่ส่งผลต่อระดับค่าฝุ่น PM2.5 ได้ดังนี้
ในด้านบวก หรือปัจจัยที่ส่งผลให้ PM2.5 เพิ่มสูงขึ้น ได้แก่:

PM10 ซึ่งมีความสัมพันธ์เชิงบวกอย่างชัดเจนกับ PM2.5

อุณหภูมิ (temperature) ที่สูงขึ้นมีแนวโน้มทำให้ค่าฝุ่น PM2.5 สูงขึ้นเช่นกัน

ความกดอากาศ (pressure) ที่สัมพันธ์ในทางบวกด้วยเช่นกัน

ในขณะที่ปัจจัยด้านลบหรือสิ่งที่มีแนวโน้มช่วยลดระดับฝุ่น PM2.5 ได้แก่:

ความเร็วลม (Wind Speed) ซึ่งช่วยพัดพาฝุ่นออกจากพื้นที่

ความชื้น (humidity) ซึ่งสามารถจับฝุ่นให้ตกลงสู่พื้น

# PM2.5 and Weather Dashboard
